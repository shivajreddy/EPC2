            ...
            <Popover>
              ...
              <PopoverContent>
                ...
                <p className="text-sm">
                  ...
                  2. Browse for the folder where you want to save the file.<br />
                  3. Select Excel Workbook <b>(*.xlsx)</b> from the Save as type drop-down menu.
                </p>
              </PopoverContent>
            </Popover>
          </div>
            ...
            <Popover>
              ...
              <PopoverContent>
                <p className="text-sm">Override <b>My View</b> configuration with the
                  the current configuration on EPC.</p>
              </PopoverContent>
            </Popover>
          </div>
          <div>
